                      ...
                      <table id="datatable" class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          ...
                          <tr class="even pointer">
                            ...
                            <td ><a href="<?php echo base_url('Group/update_group/').$row->g_id;?>"><span class="btn btn-success glyphicon glyphicon-pencil"></span></a></td>
                             <td><a href="<?php echo base_url('Group/single_delete/').$row->g_id;?>"><p><i class="btn btn-danger glyphicon glyphicon-trash" onclick="return confirm('are you sure?');">
