                     ...
                     <table id="datatable" class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" "><?php echo $row->product_price;?></td>
                            <td class=" "><?php echo $row->quantity;?></td>
							
							 <td><?php if($row->status==1){?><a href="<?php echo site_url('Product_c/disable/').$row->product_id;?>"><button class="btn btn-info btn-xs" >Disabe</button></a>
							<?php }else{?>
							<a href="<?php echo site_url('Product_c/enable/').$row->product_id;?>"><button class="btn btn-danger btn-xs" >Enable</button></a><?php }?></td>
